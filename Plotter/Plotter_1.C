...
input_Data.push_back("/home/alejandro/CMS/data/data_plot/Single_muon/allData");

input_MC.push_back("/home/alejandro/CMS/data/data_plot/Single_muon/VV");
input_MC.push_back("/home/alejandro/CMS/data/data_plot/Single_muon/DY+Jets");
input_MC.push_back("/home/alejandro/CMS/data/data_plot/Single_muon/tt");

input_MC.push_back("/home/alejandro/CMS/data/data_plot/Single_muon/W+Jets");
...
//setTDRStyle();
  ...
  for(int i = 0; i < input_MC.size(); i++){
  TH1F* h;
  if(i!=5) h = (TH1F*)Mc[i]->Get((Cut[j]+"/"+Histo[k]).c_str()); 
